                        ...
                        if event.key==K_n:
                            ...
                            while T:
                                ...
                                if sum(sumPC)<16:
                                    ...
                                    text9 = basicFont.render(" Press 'SPACE' to continue. ", True, RED, STEELBLUE)
                                    text9Rect = text1.get_rect()
                                    text9Rect.centerx = 780
                                    text9Rect.centery = 320
