...
white_soldier8 =pygame.Rect(440, 80, 60, 60)  
            ...
            for a in range(8):
                for b in range(8):
                    if event.pos[0]>(60*a-30) and event.pos[1]>(60*b-30) and event.pos[0]<(60*a+30) and event.pos[1]<(60*b+30):
                        ...
                        if (black_queen.left+30)>(60*a-30) and (black_queen.top-30)>(60*b-30) and (black_queen.left+30)<(60*a+30) and (black_queen.top-30)<(60*b+30):
                            choosen=black_queen
                        ...
                        if (white_queen.left+30)>(60*a-30) and (white_queen.top-30)>(60*b-30) and (white_queen.left+30)<(60*a+30) and (white_queen.top-30)<(60*b+30):
                            choosen=white_queen
...
def blackeatwhite(chees):
    ...
    if chees.left==white_knight2.left and chees.top==white_knight2.top :
        white_knight2.remove(white_knight2)
    if chees.left==white_rock1.left and chees.top==white_rock1.top :
        white_rock1.remove(white_rock1)
    if chees.left==white_rock2.left and chees.top==white_rock2.top :
        white_rock2.remove(white_rock2)
    if chees.left==white_bishop1.left and chees.top==white_bishop1.top :
        white_bishop1.remove(white_bishop1)
    if chees.left==white_bishop2.left and chees.top==white_bishop2.top :
        white_bishop2.remove(white_bishop2)
    if chees.left==white_queen.left and chees.top==white_queen.top :
        white_queen.remove(white_queen)
    if chees.left==white_soldier1.left and chees.top==white_soldier1.top :
        white_soldier1.remove(white_soldier1)
    if chees.left==white_soldier2.left and chees.top==white_soldier2.top :
        white_soldier2.remove(white_soldier2)
    if chees.left==white_soldier3.left and chees.top==white_soldier3.top :
        white_soldier3.remove(white_soldier3)
    if chees.left==white_soldier4.left and chees.top==white_soldier4.top :
        white_soldier4.remove(white_soldier4)
    if chees.left==white_soldier5.left and chees.top==white_soldier5.top :
        white_soldier5.remove(white_soldier5)
    if chees.left==white_soldier6.left and chees.top==white_soldier6.top :
        white_soldier6.remove(white_soldier6)
    if chees.left==white_soldier7.left and chees.top==white_soldier7.top :
        white_soldier7.remove(white_soldier7)
    if chees.left==white_soldier8.left and chees.top==white_soldier8.top :
        white_soldier8.remove(white_soldier8)
    if chees.left==white_king.left and chees.top==white_king.top :
        white_king.left=0
        white_king.top =0
...
def whiteeatblack(chees):
    ...
    if chees.left==black_knight2.left and chees.top==black_knight2.top :
        black_knight2.remove(black_knight2)
    if chees.left==black_rock1.left and chees.top==black_rock1.top :
        black_rock1.remove(black_rock1)
    if chees.left==black_rock2.left and chees.top==black_rock2.top :
        black_rock2.remove(black_rock2)
    if chees.left==black_bishop1.left and chees.top==black_bishop1.top :
        black_bishop1.remove(black_bishop1)
    if chees.left==black_bishop2.left and chees.top==black_bishop2.top :
        black_bishop2.remove(black_bishop2)
    if chees.left==black_queen.left and chees.top==black_queen.top :
        black_queen.remove(black_queen)
    if chees.left==black_soldier1.left and chees.top==black_soldier1.top :
        black_soldier1.remove(black_soldier1)
    if chees.left==black_soldier2.left and chees.top==black_soldier2.top :
        black_soldier2.remove(black_soldier2)
    if chees.left==black_soldier3.left and chees.top==black_soldier3.top :
        black_soldier3.remove(black_soldier3)
    if chees.left==black_soldier4.left and chees.top==black_soldier4.top :
        black_soldier4.remove(black_soldier4)
    if chees.left==black_soldier5.left and chees.top==black_soldier5.top :
        black_soldier5.remove(black_soldier5)
    if chees.left==black_soldier6.left and chees.top==black_soldier6.top :
        black_soldier6.remove(black_soldier6)
    if chees.left==black_soldier7.left and chees.top==black_soldier7.top :
        black_soldier7.remove(black_soldier7)
    if chees.left==black_soldier8.left and chees.top==black_soldier8.top :
        black_soldier8.remove(black_soldier8)
    if chees.left==black_king.left and chees.top==black_king.top :
        black_king.left=0
        black_king.top =0
