                        ...
                        for b in range(9):
                            ...
                            if event.pos[0]>(60*a-30) and event.pos[1]>(60*b+30) and event.pos[0]<(60*a+30) and event.pos[1]<(60*b+90):
                                ...
                                if choosen==black_king:
                                    ...
                                    if white_soldier1.left==20 and white_soldier1.top==80 and 60*a+20>white_soldier1.left and 60*a-40<white_soldier1.left and 60*b+40>white_soldier1.top and 60*b-20<white_soldier1.top+120:
                                        white_soldier1.left=60*a-30
                                        white_soldier1.top =60*b+90
                                        print 1
                                    if white_soldier1.left!=30 and white_soldier1.top!=150 and 60*a+20>white_soldier1.left and 60*a-40<white_soldier1.left+60 and 60*b>white_soldier1.top and 60*b<white_soldier1.top+60:
                                        white_soldier1.left=60*a-30
                                        white_soldier1.top =60*b+90
                                        print 1
